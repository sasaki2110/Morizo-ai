#!/usr/bin/env python3
"""
Supabase MCP Server (Annotation-based)
公式チュートリアルに従ったアノテーション方式のMCPサーバー
"""
...
if __name__ == "__main__":
    print("🚀 Supabase MCP Server (Annotation-based) starting...")
    print("📡 Available tools: inventory_add, inventory_list, inventory_get, inventory_update, inventory_delete")
    print("🌐 Server will run on http://0.0.0.0:8002/mcp")
    print("Press Ctrl+C to stop the server")
    
    # HTTPトランスポートで起動（アノテーション方式）
